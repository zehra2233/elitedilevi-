      ...
      <section className="relative h-auto lg:h-[300px] overflow-hidden bg-white">
        <div className="flex flex-col-reverse lg:flex-row">
          <div className="relative z-10 w-full lg:w-[600px] shrink-0 bg-white px-6 sm:px-10 md:pl-16 lg:pl-32 pt-6 pb-4 sm:pt-8 sm:pb-6 lg:py-0 flex flex-col justify-center overflow-hidden">
            <div className="animate-slide-in-right mt-6">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                Get exam-ready with focused Goethe-Zertifikat preparation
                covering all four skills. Learn proven strategies, practice
                with real exam formats, and build the confidence to reach
                your target level.
              </p>
            </div>
          </div>
          ...
          <div className="relative w-full lg:w-auto lg:flex-1 min-w-0 h-64 sm:h-80 lg:h-[300px]">
            <Image
              src="/exam.jpg"
              alt="Goethe-Zertifikat Preparation"
              fill
            ...
            <div className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 bg-white rounded-2xl shadow-xl px-5 py-4 flex flex-col items-center text-center">
              <Image
              ...
              />
              <div className="w-16 h-[2px] bg-gray-200 mt-2.5 mb-2.5" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-0 pb-16 sm:pt-4 lg:pt-16 lg:-translate-x-8">
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">What Is The Goethe-Zertifikat?</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
              The Goethe-Zertifikat is a series of German language exams developed and administered by the Goethe-Institut, the official cultural institute of Germany. It is one of the most widely recognized German language certifications worldwide, aligned with the Common European Framework of Reference for Languages (CEFR) from A1 to C2.
            </p>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8">
              The Goethe-Zertifikat is accepted by universities, employers, and government authorities across Germany and other German-speaking countries. It is often required for university admission, naturalization applications, and professional recognition procedures in Germany.
            </p>

            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">What Are The Types And Content Of The Goethe Exam?</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-6">
              The Goethe exam is offered at six CEFR levels, each testing Reading, Listening, Writing, and Speaking skills:
            </p>

            <div className="flex flex-col gap-6 mb-8">
              <div>
                <h3 className="font-bold text-gray-600 text-base sm:text-lg mb-1.5">
                  Goethe-Zertifikat A1
                </h3>
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  The entry level, confirming very basic German skills. Often required for family reunification visa applications to Germany.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Demonstrates the ability to communicate in simple, routine situations. A common requirement for extended family visas and early integration programs.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Proves independent use of German in everyday, academic, and professional contexts. Frequently required for long-term residence permits and naturalization applications.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Confirms the ability to understand complex texts and communicate fluently and spontaneously. This level is often required for professional recognition procedures and vocational training programs in Germany.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Demonstrates advanced German proficiency suitable for university study and demanding professional environments. This is the most commonly required level for university admission in Germany.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  The highest level offered, proving near-native command of German. Suitable for academic careers, doctoral studies, and specialized professional fields.
                </p>
              </div>
            </div>

            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">Institutions That Accept The Goethe Exam And Its Validity Period</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
              The Goethe-Zertifikat has no official expiration date, though many institutions and immigration offices prefer certificates issued within the last 2 years.
            </p>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8">
              The Goethe-Zertifikat is recognized by universities, employers, and government agencies across Germany, Austria, and Switzerland, as well as internationally. It is accepted by the German Federal Office for Migration and Refugees (BAMF), university admissions offices (uni-assist), and professional licensing boards. You can find information on which institutions accept each Goethe level, along with minimum score requirements for your specific goal.
            </p>

            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">Goethe Course One-on-One Training Program</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
              Our one-on-one training programs are completely customized to the individual needs of the participant and the areas where they feel they need improvement. Before starting the one-on-one training program, after a level assessment and needs analysis, your target Goethe level and the level you might achieve during the assessment will be used to calculate how many hours of lessons you will need, and your plan will be made accordingly. Lesson days and times are also determined entirely according to your and the instructor&apos;s availability, providing you with flexibility in terms of days and times.
            </p>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8">
              The goal of this training program is to help you confidently reach your target certification level using the technical tips provided in class and the extra support given by our instructors to help you outside the class.
            </p>

            <div className="bg-[#F7FAFF] rounded-md py-6 pr-6">
              <p className="text-[#0E1E4A] text-base sm:text-lg">
                For pricing and other information regarding our Goethe-Zertifikat preparation programs, please contact us via WhatsApp{" "}
                <a
