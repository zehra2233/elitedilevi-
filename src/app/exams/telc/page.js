...
export default function TelcPage() {
  ...
  const categoryLabels = {
    "one-on-one": "One-on-One telc Preparation",
  };
      ...
      <section className="relative h-auto lg:h-[300px] overflow-hidden bg-white">
        <div className="flex flex-col-reverse lg:flex-row">
          <div className="relative z-10 w-full lg:w-[600px] shrink-0 bg-white px-6 sm:px-10 md:pl-16 lg:pl-32 pt-6 pb-4 sm:pt-8 sm:pb-6 lg:py-0 flex flex-col justify-center overflow-hidden">
            <div className="animate-slide-in-right mt-6">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                Get exam-ready with focused telc preparation covering all
          ...
          <div className="relative w-full lg:w-auto lg:flex-1 min-w-0 h-64 sm:h-80 lg:h-[300px]">
            ...
            <div className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 bg-[#0B1B4D] rounded-2xl shadow-xl px-0 pt-2 pb-4 flex flex-col items-center text-center">
              <Image
                src="/telcc.webp"
                alt="telc"
                width={220}
              ...
              />
              <div className="w-16 h-[2px] bg-white/20 mt-2.5 mb-2.5" />
              <span className="text-sm font-bold text-white leading-snug">Official Test<br />Preparation</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-0 pb-16 sm:pt-4 lg:pt-16 lg:-translate-x-8">
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">What Is telc?</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
              telc (The European Language Certificates) is a Germany-based examination system that offers standardized language certificates across many languages, most notably German, English, and several other European languages. telc exams are developed under quality-assured, CEFR-aligned standards and are recognized internationally for education, work, and immigration purposes.
            </p>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8">
              telc GmbH is a subsidiary of the German Adult Education Association (Deutscher Volkshochschul-Verband), and its exams are widely used across German Volkshochschulen (adult education centers), integration courses, and professional certification programs throughout Germany and Europe.
            </p>

            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">What Are The Types And Content Of The telc Exam?</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-6">
              The telc Deutsch exam is offered at multiple CEFR levels, each testing Reading, Listening, Writing, and Speaking skills:
            </p>
            ...
            <div className="flex flex-col gap-6 mb-8">
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Confirms basic German skills for everyday situations. Commonly required for spousal visa and family reunification applications to Germany.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Certifies the ability to handle simple, routine communication. Often required for integration courses and residence permit renewals.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Proves independent use of German in daily life, and is the standard requirement for the &quot;Zertifikat Integrationskurs&quot; and German citizenship applications.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Demonstrates the ability to communicate fluently on a wide range of topics. Frequently required for professional recognition procedures and some vocational training programs.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  Confirms advanced academic German proficiency and is specifically designed and accepted for university admission in Germany.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                  The highest levels offered, proving near-native command of German for demanding professional and academic environments.
                </p>
              </div>
            </div>

            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">Institutions That Accept The telc Exam And Its Validity Period</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
              telc certificates have no official expiration date, though many institutions and immigration offices prefer certificates issued within the last 2 years.
            </p>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8">
              telc exams are recognized by German immigration authorities (including for integration courses and citizenship applications), universities, employers, and Volkshochschulen across Germany, Austria, and other European countries. You can find information on which institutions accept each telc level, along with minimum score requirements for your specific goal.
            </p>

            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">telc Course One-on-One Training Program</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
              Our one-on-one training programs are completely customized to the individual needs of the participant and the areas where they feel they need improvement. Before starting the one-on-one training program, after a level assessment and needs analysis, your target telc level and the level you might achieve during the assessment will be used to calculate how many hours of lessons you will need, and your plan will be made accordingly. Lesson days and times are also determined entirely according to your and the instructor&apos;s availability, providing you with flexibility in terms of days and times.
            </p>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8">
            ...
            <div className="bg-[#F7FAFF] rounded-md py-6 pr-6">
              <p className="text-[#0E1E4A] text-base sm:text-lg">
                For pricing and other information regarding our telc preparation programs, please contact us via WhatsApp{" "}
                <a
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <CustomSelect
                  ...
                  options={[
                    { value: "one-on-one", label: "One-on-One telc Preparation" },
                  ]}
                />
              </div>
