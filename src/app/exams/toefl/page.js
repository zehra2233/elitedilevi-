...
export default function TOEFLPage() {
  ...
  const categoryLabels = {
    "one-on-one": "One-on-One TOEFL Preparation",
    "essentials": "TOEFL Essentials Preparation",
  };
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <CustomSelect
                  ...
                  options={[
                    { value: "one-on-one", label: "One-on-One TOEFL Preparation" },
                    { value: "essentials", label: "TOEFL Essentials Preparation" },
                  ]}
                />
              </div>
