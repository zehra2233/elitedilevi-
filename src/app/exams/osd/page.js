...
const osdLevels = [
  { level: "A1", accent: "#D9A441", bg: "#FEF6E7", exams: ["ZA1", "KID A1"] },
  { level: "A2", accent: "#2E9E5B", bg: "#EFFAF1", exams: ["ZA2", "KID A2"] },
  { level: "B1", accent: "#1B5FAE", bg: "#EAF2FF", exams: ["ZDÖ B1", "ZB1"] },
  { level: "B2", accent: "#7C4DBE", bg: "#F5F0FB", exams: ["ZB2"] },
  { level: "C1", accent: "#0F9B8E", bg: "#E9FAF8", exams: ["ZC1"] },
  { level: "C2", accent: "#B22222", bg: "#FDECEC", exams: ["ZC2"] },
];

const candidates = [
  {
    title: "Children and young people",
    desc: "There are specially adapted exam formats for candidates aged 10 and above.",
  },
  {
    title: "Adults",
    desc: "General German language proficiency exams are available for candidates aged 16 and over.",
  },
  {
    title: "Professionals",
    desc: "Special exam options are available for individuals wishing to work in German-speaking countries.",
  },
];
...
export default function OSDPage() {
  ...
  const categoryLabels = {
    "one-on-one": "One-on-One ÖSD Preparation",
  };
        ...
        <div className="flex flex-col-reverse lg:flex-row">
          <div className="relative z-10 w-full lg:w-[600px] shrink-0 bg-white px-6 sm:px-10 md:pl-16 lg:pl-32 pt-6 pb-4 sm:pt-8 sm:pb-6 lg:py-0 flex flex-col justify-center overflow-hidden">
            <div className="animate-slide-in-right mt-6">
              ...
              <p className="text-[#1B5FAE] font-semibold mb-4">
                Austrian German Language Diploma
              </p>
              <p className="text-gray-600 max-w-md mb-8">
                Get exam-ready with focused ÖSD preparation covering all
          ...
          <div className="relative w-full lg:w-auto lg:flex-1 min-w-0 h-64 sm:h-80 lg:h-[300px]">
            ...
            <div className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 bg-white rounded-2xl shadow-xl px-5 py-4 flex flex-col items-center text-center">
              <span className="text-6xl font-bold text-[#1D8FD6] tracking-tight lowercase">ösd</span>
              <span className="text-[10px] font-semibold text-[#0B3D6B] tracking-[0.1em] mt-2 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-0 pb-16 sm:pt-4 lg:pt-16 lg:-translate-x-8">
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">What Is ÖSD?</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
              The ÖSD (Österreichisches Sprachdiplom Deutsch) is a state-approved examination and assessment system that evaluates the language skills of individuals learning German. Designed for candidates learning German as a foreign or second language, the ÖSD exams are aligned with the Common European Framework of Reference for Languages ​​(CEFR) levels and have international validity.
            </p>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-8">
              The ÖSD (Austrian German Language Test) is not only an Austrian-based examination system, but it also covers the different regional variations of German spoken in Austria, Switzerland, and Germany. Therefore, the exams take into account the fact that German is a polycentric language and reflect the standard linguistic diversity of all German-speaking countries in their content.
            </p>

            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">ÖSD Exam Levels</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-6">
              ÖSD offers exam options suitable for every age group and language level. Each exam level includes specific modules that assess candidates&apos; language skills in different contexts. Candidates can take an exam for one of the following levels to document their language proficiency:
            </p>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 mb-8">
              {osdLevels.map((lvl) => (
                ...
                >
                  <p className="text-sm font-bold mb-1" style={{ color: lvl.accent }}>
                    {lvl.level}
                  </p>
                  <div className="flex flex-wrap gap-1">
                    {lvl.exams.map((exam) => (
                      <span
                        ...
                        style={{ backgroundColor: `${lvl.accent}26`, color: lvl.accent }}
                      >
                        {exam}
                      </span>
                    ))}
            ...
            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">Who Can Take The ÖSD Exam?</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-6">
              ÖSD exams cater to a wide age range, from children to adults.
            </p>
            ...
            <ul className="flex flex-col gap-4 mb-8">
              {candidates.map((c) => (
                <li key={c.title} className="flex items-start gap-2">
                  ...
                  <span className="text-gray-600 text-base sm:text-lg leading-relaxed">
                    <span className="font-bold text-gray-600">{c.title}: </span>
                    {c.desc}
                  </span>
                </li>
              ))}
            ...
            <h2 className="text-2xl font-bold text-[#314A8A] mb-3">Document Your German Language Proficiency With ÖSD.</h2>
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-4">
              If you want to prove your proficiency with an official certificate during your German language learning process, ÖSD exams are the right choice for you. If you want to study, work, or live in a German-speaking country, an ÖSD certificate will give you a significant advantage in achieving your goals.
            </p>

            <div className="bg-[#F7FAFF] rounded-md py-6 pr-6">
              <p className="text-[#0E1E4A] text-base sm:text-lg">
                For pricing and other information regarding our ÖSD preparation programs, please contact us via WhatsApp{" "}
                <a
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <CustomSelect
                  ...
                  options={[
                    { value: "one-on-one", label: "One-on-One ÖSD Preparation" },
                  ]}
                />
              </div>
