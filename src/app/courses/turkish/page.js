...
const highlights = [
  ...
  },
  {
    ...
    desc: "Learn from qualified and friendly instructors.",
...
const overview = [
  { label: "Levels", value: "A1 – C1", icon: "M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" },
...
const levels = [
  ...
  },
  {
    ...
    bg: "#FDF0F0",
    accent: "#C24E4E",
    desc: "Use Turkish fluently and effectively in academic and professional settings.",
    points: ["Academic language use", "Professional writing", "Presentation skills", "Discussing complex topics", "Advanced vocabulary"],
  },
];
...
const skills = [
  ...
  {
    title: "Listening",
    desc: "Understand conversations, lectures, interviews and authentic Turkish audio.",
    ...
    <main>
          ...
          <div className="relative z-10 w-full lg:w-[600px] shrink-0 bg-white px-6 sm:px-10 md:pl-16 lg:pl-32 pt-8 pb-10 sm:pt-10 sm:pb-12 lg:py-0 flex flex-col justify-center overflow-hidden">
            <div className="animate-slide-in-right">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                Our Turkish Language Course is designed to help you build
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-[#E4ECF7] rounded-md p-8 flex flex-col h-full">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              ...
              After finishing all levels, you will receive a Qualified
              Turkish Language Certificate issued by our institution.
            </p>
            <div className="bg-white/60 rounded-md p-4 flex items-center justify-between gap-4 mt-auto">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[#0E1E4A] text-sm leading-snug">
                  A recognized credential that shows your Turkish
                  proficiency to schools, employers, and institutions.
                </p>
              </div>
              <div className="hidden sm:grid grid-cols-4 gap-1.5 shrink-0">
                {Array.from({ length: 16 }).map((_, i) => (
      ...
      <section className="bg-[#F7FAFF] py-16">
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          ...
          <div ref={levelsRef} className="grid sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {levels.map((lvl, i) => (
              <div
                key={lvl.code}
                style={{
