...
const highlights = [
  ...
  },
  {
    ...
    desc: "TOEFL · IELTS · PTE curriculum.",
...
const levels = [
  ...
  },
  {
    ...
    bg: "#FDF0F0",
    accent: "#C24E4E",
    desc: "Use English fluently and effectively in academic and professional settings.",
...
const skills = [
  ...
  {
    title: "Listening",
    desc: "Understand conversations, lectures, interviews and authentic English audio.",
...
export default function AdultsEnglishCoursePage() {
          ...
          <div className="relative z-10 w-full lg:w-[600px] shrink-0 bg-white px-6 sm:px-10 md:pl-16 lg:pl-32 py-14 lg:py-0 flex flex-col justify-center overflow-hidden">
            <div className="animate-slide-in-right">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                Our Adult English Course is designed to help you build strong
                language skills for education, work, travel and everyday
                communication, with a clear track into TOEFL, IELTS or
                Pearson exam preparation.
              </p>
              <div>
                <Link
                  href="/registration"
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 pb-8">
        <div className="bg-[#EAF3FF] rounded-md px-6 py-5 flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex-1 text-center sm:text-left">
            <p className="font-bold text-[#314A8A]">Ready to start learning English?</p>
