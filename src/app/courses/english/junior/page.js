...
const highlights = [
  {
    ...
    desc: "Personal attention and more speaking practice for every child.",
    icon: "M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z",
  },
  {
    title: "All Materials Included",
    desc: "Books and study materials included in the course fee.",
    icon: "M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25",
  },
  {
    title: "Fun & Interactive Lessons",
    desc: "Games, songs and activities that make learning enjoyable.",
...
const overview = [
  { label: "Ages", value: "6 – 14", icon: "M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" },
...
const levels = [
  {
    ...
    bg: "#FEF6E7",
    accent: "#D9A441",
    desc: "Playful introduction to English through songs, stories and games.",
    points: ["Alphabet & phonics", "Colors, numbers & animals", "Simple greetings", "Listening games", "Basic vocabulary"],
  },
  {
    code: "A2",
    title: "Junior",
    bg: "#EFFAF1",
    accent: "#2E9E5B",
    desc: "Building confidence with everyday English in a fun classroom setting.",
    points: ["Everyday conversations", "Reading short stories", "Simple writing", "Grammar basics", "Group activities"],
  },
  {
    code: "B1",
    title: "Pre-Teen",
    bg: "#EAF2FF",
    accent: "#1B5FAE",
    desc: "Developing stronger skills to prepare for teen and exam-level English.",
    points: ["Wider vocabulary", "Paragraph writing", "Reading comprehension", "Presentation skills", "Exam-style practice"],
  },
];
...
const skills = [
  {
    title: "Speaking",
    desc: "Build confidence speaking English in class and everyday situations.",
    icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z",
  },
  {
    title: "Listening",
    desc: "Understand songs, stories and conversations in English.",
  ...
  {
    title: "Reading",
    desc: "Enjoy age-appropriate stories and simple texts with confidence.",
    icon: "M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25",
  },
  {
    title: "Writing",
    desc: "Practice simple sentences, short stories and everyday writing.",
...
const studyMaterials = [
  ...
  "Classroom handouts",
  "Songs & storybooks",
  "No need to purchase additional books",
];

export default function JuniorEnglishCoursePage() {
    ...
    <main>
      ...
      <section className="relative h-auto lg:h-[420px] overflow-hidden bg-white">
        <div className="flex flex-col lg:flex-row">
          <div className="relative z-10 w-full lg:w-[600px] shrink-0 bg-white px-6 sm:px-10 md:pl-16 lg:pl-32 pt-8 pb-10 sm:pt-10 sm:pb-12 lg:py-0 flex flex-col justify-center overflow-hidden">
            <div className="animate-slide-in-right">
              ...
              <p className="text-gray-600 max-w-md mb-8">
                Our Junior English Course helps kids build real confidence in
                English through fun, interactive lessons, small class sizes,
                and experienced teachers who make learning enjoyable.
              </p>
              <div>
                <Link
                  href="/registration"
          ...
          <div className="relative w-full lg:w-auto lg:flex-1 min-w-0 h-64 sm:h-80 lg:h-[420px]">
            <Image
              src="/juniorenglish.jpg"
              alt="Junior English Course"
              fill
        ...
        <div ref={overviewRef} className="flex flex-wrap lg:flex-nowrap gap-4">
          {overview.map((o, i) => (
            <div
              ...
              className={`flex-1 min-w-[220px] flex items-start gap-4 bg-white rounded-md shadow-sm border border-gray-100 px-6 py-4 ${overviewVisible ? "animate-rise-up" : "opacity-0"}`}
            >
              <svg
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 pb-8">
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-[#0B1B4D] rounded-md p-8 flex flex-col h-full">
            <h2 className="text-lg font-bold tracking-wide text-white uppercase mb-2">
              Materials Included
            </h2>
            <div className="h-[3px] w-10 bg-[#D9A441] rounded-full mb-4" />
            ...
            <div className="bg-white/10 rounded-md p-4 flex items-center justify-between gap-4 mt-auto">
              <div className="flex items-center gap-3">
                <svg className="w-10 h-10 text-[#D9A441] shrink-0" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
          ...
          <div className="bg-[#E4ECF7] rounded-md p-8 flex flex-col h-full">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              Students who successfully complete each level receive a{" "}
              <span className="font-semibold text-[#314A8A]">Course Completion Certificate</span>,
              recognizing their progress and encouraging them to keep learning.
            </p>
            <div className="bg-white/60 rounded-md p-4 flex items-center justify-between gap-4 mt-auto">
              <div className="flex items-center gap-3">
                ...
                <p className="text-[#0E1E4A] text-sm leading-snug">
                  A recognized credential that celebrates every young
                  learner&apos;s progress along the way.
                </p>
              </div>
              <div className="hidden sm:grid grid-cols-4 gap-1.5 shrink-0">
                {Array.from({ length: 16 }).map((_, i) => (
      ...
      <section className="bg-[#F7FAFF] py-16">
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          ...
          <div ref={levelsRef} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {levels.map((lvl, i) => (
              <div
                key={lvl.code}
                style={{
      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 pb-8">
        <div className="bg-[#EAF3FF] rounded-md px-6 py-5 flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex-1 text-center sm:text-left">
            <p className="font-bold text-[#314A8A]">Ready to start your child&apos;s English journey?</p>
