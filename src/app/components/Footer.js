...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-[#0B1B4D] to-[#12296B] text-white pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
        <div>
          <Image
            src="/logo.jpeg"
            alt="Elite Dil Evi"
        ...
        <div>
          ...
          <span className="block h-[2px] w-8 bg-[#1B5FAE] mb-4" />
            ...
            {[
              ...
              <li key={c.label}>
                <Link href={c.href} className="flex items-center gap-2 hover:text-white transition">
                  <span className="text-[#1B5FAE]">›</span> {c.label}
                </Link>
              </li>
            ))}
          </ul>
            ...
            {[
              ...
              <li key={l.label}>
                <Link href={l.href} className="flex items-center gap-2 hover:text-white transition">
                  <span className="text-[#1B5FAE]">›</span> {l.label}
                </Link>
              </li>
            ))}
          </ul>
            ...
            {[
              ...
              <li key={e.label}>
                <Link href={e.href} className="flex items-center gap-2 hover:text-white transition">
                  <span className="text-[#1B5FAE]">›</span> {e.label}
                </Link>
              </li>
            ))}
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-3 text-base text-white/80">
            <li className="flex items-center gap-3">
              <svg className="w-5 h-5 text-[#1B5FAE] shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <li className="flex items-start gap-3">
              <svg className="w-5 h-5 text-[#1B5FAE] shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 mt-6 pt-4 border-t border-white/10 text-center">
