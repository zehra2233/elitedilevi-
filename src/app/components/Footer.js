      ...
      <div className="px-8 sm:px-12 xl:px-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[220px_1fr_1fr_1fr] gap-8 lg:gap-x-40">
        <div>
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <a href="https://www.instagram.com/elitedil_evi" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition">
              <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
