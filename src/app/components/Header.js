...
export default function Header() {
  ...
  const dropdownLinkClass = (href) =>
    `block px-4 py-2 hover:bg-gray-100 hover:text-blue-700 transition ${
      pathname === href ? "text-blue-700 font-semibold bg-gray-100" : ""
    }`;
  ...
  return (
    <header className="sticky top-0 z-50 bg-white">
      {/* Top contact bar */}
      <div className="hidden lg:block bg-[#1B5FAE] text-white text-sm">
        <div className="flex items-center justify-between px-6 xl:px-10 py-2">
      ...
      {/* Main header */}
      <div className="flex items-center justify-between px-4 sm:px-6 xl:px-10 py-2 shadow-sm relative">
        <Link href="/" className="shrink-0">
          <Image
            ...
            width={70}
            height={70}
            className="h-12 sm:h-14 lg:h-[70px] w-auto"
          />
        </Link>
        ...
        <nav className="hidden lg:flex gap-6 text-base text-gray-700 items-center">
          ...
          >
            <button
              className={`flex items-center gap-1 hover:text-blue-700 transition ${
                coursesActive ? "text-blue-700 font-semibold" : ""
              }`}
            >
              Courses
            ...
            {coursesOpen && (
              <div className="absolute top-full left-0 bg-white shadow-lg rounded-md py-2 w-48 z-50">
                ...
                >
                  <button
                    className={`w-full text-left flex items-center justify-between px-4 py-2 hover:bg-gray-100 hover:text-blue-700 transition ${
                      englishActive ? "text-blue-700 font-semibold bg-gray-100" : ""
                    }`}
                  >
                    English
                    <span className="text-xs font-light text-gray-400">▶</span>
          ...
          >
            <button
              className={`flex items-center gap-1 hover:text-blue-700 transition ${
                examsActive ? "text-blue-700 font-semibold" : ""
              }`}
            >
              Exam Preparation
              <span className="text-xs font-light text-gray-400">▼</span>
          ...
          <Link href="/university-guidance" className={navLinkClass("/university-guidance")}>University Guidance</Link>
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/contact"
            className="hidden sm:inline-block bg-red-600 text-white font-bold px-4 sm:px-6 py-2.5 sm:py-3 rounded hover:bg-red-700 transition animate-pulse-scale text-sm sm:text-base"
          >
            CONTACT US
          </Link>
      ...
      {mobileOpen && (
        <nav className="lg:hidden bg-white border-t border-gray-100 px-4 py-4 flex flex-col gap-1 text-gray-700 max-h-[80vh] overflow-y-auto">
          ...
          <details className="py-2" open={coursesActive}>
            <summary className={`cursor-pointer list-none flex items-center justify-between ${coursesActive ? "text-blue-700 font-semibold" : ""}`}>
              Courses <span className="text-xs text-gray-400">▼</span>
            </summary>
            <div className="pl-4 mt-2 flex flex-col gap-2">
              <Link href="/courses/german" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/courses/german" ? "text-blue-700 font-semibold" : ""}`}>German</Link>
              <Link href="/courses/english/junior" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/courses/english/junior" ? "text-blue-700 font-semibold" : ""}`}>English (Junior)</Link>
              <Link href="/courses/english/adults" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/courses/english/adults" ? "text-blue-700 font-semibold" : ""}`}>English (Adults)</Link>
              <Link href="/courses/turkish" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/courses/turkish" ? "text-blue-700 font-semibold" : ""}`}>Turkish</Link>
            </div>
          </details>

          <details className="py-2" open={examsActive}>
            <summary className={`cursor-pointer list-none flex items-center justify-between ${examsActive ? "text-blue-700 font-semibold" : ""}`}>
              Exam Preparation <span className="text-xs text-gray-400">▼</span>
            </summary>
            <div className="pl-4 mt-2 flex flex-col gap-2">
              <Link href="/exams/toefl" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/exams/toefl" ? "text-blue-700 font-semibold" : ""}`}>TOEFL</Link>
              <Link href="/exams/ielts" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/exams/ielts" ? "text-blue-700 font-semibold" : ""}`}>IELTS</Link>
              <Link href="/exams/pte" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/exams/pte" ? "text-blue-700 font-semibold" : ""}`}>PTE</Link>
              <Link href="/exams/telc" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/exams/telc" ? "text-blue-700 font-semibold" : ""}`}>TELC</Link>
              <Link href="/exams/goethe" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/exams/goethe" ? "text-blue-700 font-semibold" : ""}`}>GOETHE</Link>
              <Link href="/exams/osd" onClick={() => setMobileOpen(false)} className={`py-1 ${pathname === "/exams/osd" ? "text-blue-700 font-semibold" : ""}`}>ÖSD</Link>
            </div>
          </details>

          <Link href="/university-guidance" onClick={() => setMobileOpen(false)} className={`py-2 ${navLinkClass("/university-guidance")}`}>University Guidance</Link>
