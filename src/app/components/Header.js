        ...
        <div className="flex items-center justify-between px-10 py-4">
          <div className="flex items-center gap-6 ml-48">
            <div className="flex items-center gap-2">
              ...
              <span>Head Office: 0000 000 0000</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      <div className="flex items-center justify-between px-10 py-4 shadow-sm relative">
        ...
        <nav className="hidden md:flex gap-6 text-base text-gray-700 items-center ml-64">
          ...
          >
            ...
            {coursesOpen && (
              <div className="absolute top-full left-0 bg-white shadow-lg rounded-md py-2 w-48 z-50">
                <Link href="/courses/german" className="block px-4 py-2 hover:bg-gray-100">
                  German
                </Link>
                ...
                >
                  <button className="w-full text-left flex items-center justify-between px-4 py-2 hover:bg-gray-100">
                    English
                    <span className="text-xs font-light text-gray-400">▶</span>
                  </button>
                  ...
                  {englishOpen && (
                    <div className="absolute top-0 left-full bg-white shadow-lg rounded-md py-2 w-40 z-50">
                      <Link href="/courses/english/junior" className="block px-4 py-2 hover:bg-gray-100">
                        Junior
                      </Link>
                      <Link href="/courses/english/adults" className="block px-4 py-2 hover:bg-gray-100">
                        Adults
                      </Link>
                    </div>
                  )}
                ...
                <Link href="/courses/turkish" className="block px-4 py-2 hover:bg-gray-100">
                  Turkish
                </Link>
              </div>
            )}
          ...
          >
            ...
            {examsOpen && (
              <div className="absolute top-full left-0 bg-white shadow-lg rounded-md py-2 w-48 z-50">
                <Link href="/exams/toefl" className="block px-4 py-2 hover:bg-gray-100">
                  TOEFL
                </Link>
                <Link href="/exams/ielts" className="block px-4 py-2 hover:bg-gray-100">
                  IELTS
                </Link>
                <Link href="/exams/german-exams" className="block px-4 py-2 hover:bg-gray-100">
                  German Exams
                </Link>
              </div>
            )}
          ...
          <Link href="/university-guidance">University Guidance</Link>

          <Link href="/contact">Contact</Link>
        </nav>

        <button className="bg-red-600 text-white font-bold px-6 py-3 rounded hover:bg-red-700 transition animate-pop-in">
          CONTACT US
        </button>
      </div>
    </header>
