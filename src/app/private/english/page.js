...
export default function PrivateEnglishPage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-6">
              Private lessons are entirely tailored to the student&apos;s needs. The student can add to the course content and chosen topics according to their own needs, and can determine the course content, intensity, and hours independently of any group, according to their own needs and availability. Such flexibility is one of the reasons why private lessons are preferred over group lessons.
            </p>
            ...
            <p className="text-gray-600 text-base sm:text-lg leading-relaxed mb-12">
              Classes are taught by instructors whose native language is English, and lessons are offered either online or in person, whichever suits you best.
            </p>
